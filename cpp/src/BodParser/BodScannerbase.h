...
#ifndef bod_parserBodScannerBASE_H_INCLUDED
#define bod_parserBodScannerBASE_H_INCLUDED
...
private:
    ...
    size_t (BodScannerBase::*d_get)() = &BodScannerBase::getInput;
...
public:
    BodScannerBase(BodScannerBase const &other)             = delete;
    BodScannerBase &operator=(BodScannerBase const &rhs)    = delete;
...
protected:
    BodScannerBase(std::istream &in, std::ostream &out);
    BodScannerBase(std::string const &infilename, std::string const &outfilename);
    ~BodScannerBase();
...
inline BodScannerBase::~BodScannerBase()
{
    d_input.close();
}

// $insert startcondimpl
inline BodScannerBase::StartCondition__ constexpr BodScannerBase::SC(int sc)
{
    return as<StartCondition__>(sc);
}

inline int constexpr BodScannerBase::SC(StartCondition__ sc)
{
    return as<int>(sc);
}

inline BodScannerBase::StartCondition__ BodScannerBase::startCondition() const
{
    return SC(d_startCondition);
}

inline void BodScannerBase::begin(StartCondition__ startCondition)
{
...
template <typename ReturnType, typename ArgType>
inline ReturnType constexpr BodScannerBase::as(ArgType value)
{
    return static_cast<ReturnType>(value);
}

inline bool BodScannerBase::knownFinalState()
{
    return (d_atBOL && available(d_final.bol.rule)) ||
           available(d_final.std.rule);
}

inline bool constexpr BodScannerBase::available(size_t value)
{   
    return value != std::numeric_limits<size_t>::max();
}

inline std::ostream &BodScannerBase::out()
{
    return *d_out;
}

inline void BodScannerBase::push(size_t ch)
{
    d_input.reRead(ch);
}

inline void BodScannerBase::push(std::string const &str)
{
    d_input.reRead(str, 0);
}

inline void BodScannerBase::setFilename(std::string const &name)
{
    d_filename = name;
}

inline void BodScannerBase::setMatched(std::string const &text)
{
    d_matched = text;
}

inline std::string const &BodScannerBase::matched() const
{
    return d_matched;
}

inline std::string const &BodScannerBase::filename() const
{
    return d_filename;
}

inline void BodScannerBase::echo() const
{
    *d_out << d_matched;
}

inline size_t BodScannerBase::length() const
{
    return d_matched.size();
}

inline void BodScannerBase::leave(int retValue) const
{
    throw as<Leave__>(retValue);
}

inline size_t BodScannerBase::lineNr() const
{
    return d_input.lineNr();
}

inline void BodScannerBase::more()
{
    d_more = true;
}

inline size_t BodScannerBase::state__() const
{
    return d_state;
}

inline size_t BodScannerBase::get__()
{
    return (this->*d_get)();
}

inline size_t BodScannerBase::getInput()
{
    return d_input.get();
}

inline bool BodScannerBase::return__()
{
    return d_return;
}

inline void BodScannerBase::noReturn__()
{
    d_return = false;
}
...
#endif //  BodScannerBASE_H_INCLUDED
