...
void Parser::addCube(double x, double y, double z, double s) {
  if (s < 0) {
...
void Parser::addCuboid(double x1, double y1, double z1,
...
void Parser::addVoxels(std::string voxelsFileName) {
  const std::string inputFilePath = parameters->getInputFileName();
