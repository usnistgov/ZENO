...
// hdr/includes
#ifndef bod_parserBodParserBase_h_included
#define bod_parserBodParserBase_h_included
...
// hdr/abort
inline void BodParserBase::ABORT() const
{
    throw PARSE_ABORT__;
}

// hdr/accept
inline void BodParserBase::ACCEPT() const
{
...
// hdr/error
inline void BodParserBase::ERROR() const
{
    throw UNEXPECTED_TOKEN__;
}

// hdr/savedtoken
inline int BodParserBase::savedToken__() const
{
    return d_next.first;
}

// hdr/opbitand
inline BodParserBase::DebugMode__ operator&(BodParserBase::DebugMode__ lhs,
                                     BodParserBase::DebugMode__ rhs)
{
    return static_cast<BodParserBase::DebugMode__>(
...
inline BodParserBase::DebugMode__ operator|(BodParserBase::DebugMode__ lhs, 
                                     BodParserBase::DebugMode__ rhs)
{
    return static_cast<BodParserBase::DebugMode__>(static_cast<int>(lhs) | rhs);
};

// hdr/recovery
inline bool BodParserBase::recovery__() const
{
    return d_recovery;
}

// hdr/stacksize
inline size_t BodParserBase::stackSize__() const
{
    return d_stackIdx + 1;
}

// hdr/state
inline size_t BodParserBase::state__() const
{
    return d_state;
}

// hdr/token
inline int BodParserBase::token__() const
{
    return d_token;
}

// hdr/vs
inline BodParserBase::STYPE__ &BodParserBase::vs__(int idx) 
{
...
#define BodParser BodParserBase
