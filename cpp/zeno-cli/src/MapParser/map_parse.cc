// Generated by Bisonc++ V6.01.00 on Tue, 14 Jul 2020 17:22:54 -0400

// base/comment

// $insert class.ih
#include "MapParser.ih"
...
PI__ const s_productionInfo[] = 
{
     ...
     {263, 0}, // 1: lines ->  <empty>
     {263, 3}, // 2: lines (NEWLINE) ->  lines line NEWLINE
     {264, 2}, // 3: line ->  word real
     {265, 1}, // 4: real (FLOAT) ->  FLOAT
     {265, 1}, // 5: real (INT) ->  INT
     {266, 1}, // 6: word (WORD) ->  WORD
     {266, 1}, // 7: word (FLOAT) ->  FLOAT
     {266, 1}, // 8: word (INT) ->  INT
     {267, 1}, // 9: lines_$ ->  lines
};
...
void MapParserBase::setDebug(bool mode)
{
    d_actionCases__ = false;
    d_debug__ = mode;
}

void MapParserBase::setDebug(DebugMode__ mode)
{
...
// base/lex
void MapParserBase::lex__(int token)
{
    d_token = token;
...
// base/lookup
int MapParserBase::lookup__() const
{
...
// base/pop
void MapParserBase::pop__(size_t count)
{
...
// base/push
void MapParserBase::push__(size_t state)
{
...
// base/pushtoken
void MapParserBase::pushToken__(int token)
{
...
// base/redotoken
void MapParserBase::redoToken__()
{
...
// base/reduce
void MapParserBase::reduce__(int rule)
{
...
// base/shift
void MapParserBase::shift__(int action)
{
    push__(action);
...
// base/startrecovery
void MapParserBase::startRecovery__()
{
...
// base/top
inline size_t MapParserBase::top__() const
{
    return d_stateStack[d_stackIdx].first;
}

// derived/errorrecovery
void MapParser::errorRecovery__()
{
...
void MapParser::executeAction__(int production)
try
{
    ...
    switch (production)
    {
        ...
        case 2:
#line 17 "/home/dcj/Projects/zeno/cpp/zeno-cli/src/MapParser/map_grammar"
        {
        ...
        case 3:
#line 21 "/home/dcj/Projects/zeno/cpp/zeno-cli/src/MapParser/map_grammar"
        {
         addMapping(vs__(-1).get<Tag__::STRING_TYPE>(), vs__(0).get<Tag__::FLOAT_TYPE>());
         }
        break;

        case 4:
#line 28 "/home/dcj/Projects/zeno/cpp/zeno-cli/src/MapParser/map_grammar"
        {
        ...
        case 5:
#line 33 "/home/dcj/Projects/zeno/cpp/zeno-cli/src/MapParser/map_grammar"
        {
         d_val__ = stod(d_scanner.matched());
         }
        break;
        ...
        case 6:
#line 40 "/home/dcj/Projects/zeno/cpp/zeno-cli/src/MapParser/map_grammar"
        {
        ...
        case 7:
#line 45 "/home/dcj/Projects/zeno/cpp/zeno-cli/src/MapParser/map_grammar"
        {
         d_val__ = d_scanner.matched();
         }
        break;
        ...
        case 8:
#line 50 "/home/dcj/Projects/zeno/cpp/zeno-cli/src/MapParser/map_grammar"
        {
         d_val__ = d_scanner.matched();
         }
        break;
