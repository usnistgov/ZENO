...
#ifndef map_parserMapScannerBASE_H_INCLUDED
#define map_parserMapScannerBASE_H_INCLUDED
...
private:
    ...
    size_t (MapScannerBase::*d_get)() = &MapScannerBase::getInput;
...
public:
    MapScannerBase(MapScannerBase const &other)             = delete;
    MapScannerBase &operator=(MapScannerBase const &rhs)    = delete;
...
protected:
    MapScannerBase(std::istream &in, std::ostream &out);
    MapScannerBase(std::string const &infilename, std::string const &outfilename);
    ~MapScannerBase();
...
inline MapScannerBase::~MapScannerBase()
{
    d_input.close();
}

// $insert startcondimpl
inline MapScannerBase::StartCondition__ constexpr MapScannerBase::SC(int sc)
{
    return as<StartCondition__>(sc);
}

inline int constexpr MapScannerBase::SC(StartCondition__ sc)
{
    return as<int>(sc);
}

inline MapScannerBase::StartCondition__ MapScannerBase::startCondition() const
{
    return SC(d_startCondition);
}

inline void MapScannerBase::begin(StartCondition__ startCondition)
{
...
template <typename ReturnType, typename ArgType>
inline ReturnType constexpr MapScannerBase::as(ArgType value)
{
    return static_cast<ReturnType>(value);
}

inline bool MapScannerBase::knownFinalState()
{
    return (d_atBOL && available(d_final.bol.rule)) ||
           available(d_final.std.rule);
}

inline bool constexpr MapScannerBase::available(size_t value)
{   
    return value != std::numeric_limits<size_t>::max();
}

inline std::ostream &MapScannerBase::out()
{
    return *d_out;
}

inline void MapScannerBase::push(size_t ch)
{
    d_input.reRead(ch);
}

inline void MapScannerBase::push(std::string const &str)
{
    d_input.reRead(str, 0);
}

inline void MapScannerBase::setFilename(std::string const &name)
{
    d_filename = name;
}

inline void MapScannerBase::setMatched(std::string const &text)
{
    d_matched = text;
}

inline std::string const &MapScannerBase::matched() const
{
    return d_matched;
}

inline std::string const &MapScannerBase::filename() const
{
    return d_filename;
}

inline void MapScannerBase::echo() const
{
    *d_out << d_matched;
}

inline size_t MapScannerBase::length() const
{
    return d_matched.size();
}

inline void MapScannerBase::leave(int retValue) const
{
    throw as<Leave__>(retValue);
}

inline size_t MapScannerBase::lineNr() const
{
    return d_input.lineNr();
}

inline void MapScannerBase::more()
{
    d_more = true;
}

inline size_t MapScannerBase::state__() const
{
    return d_state;
}

inline size_t MapScannerBase::get__()
{
    return (this->*d_get)();
}

inline size_t MapScannerBase::getInput()
{
    return d_input.get();
}

inline bool MapScannerBase::return__()
{
    return d_return;
}

inline void MapScannerBase::noReturn__()
{
    d_return = false;
}
...
#endif //  MapScannerBASE_H_INCLUDED
