...
// hdr/includes
#ifndef map_parserMapParserBase_h_included
#define map_parserMapParserBase_h_included
...
// hdr/abort
inline void MapParserBase::ABORT() const
{
    throw PARSE_ABORT__;
}

// hdr/accept
inline void MapParserBase::ACCEPT() const
{
...
// hdr/error
inline void MapParserBase::ERROR() const
{
    throw UNEXPECTED_TOKEN__;
}

// hdr/savedtoken
inline int MapParserBase::savedToken__() const
{
    return d_next.first;
}

// hdr/opbitand
inline MapParserBase::DebugMode__ operator&(MapParserBase::DebugMode__ lhs,
                                     MapParserBase::DebugMode__ rhs)
{
    return static_cast<MapParserBase::DebugMode__>(
...
inline MapParserBase::DebugMode__ operator|(MapParserBase::DebugMode__ lhs, 
                                     MapParserBase::DebugMode__ rhs)
{
    return static_cast<MapParserBase::DebugMode__>(static_cast<int>(lhs) | rhs);
};

// hdr/recovery
inline bool MapParserBase::recovery__() const
{
    return d_recovery;
}

// hdr/stacksize
inline size_t MapParserBase::stackSize__() const
{
    return d_stackIdx + 1;
}

// hdr/state
inline size_t MapParserBase::state__() const
{
    return d_state;
}

// hdr/token
inline int MapParserBase::token__() const
{
    return d_token;
}

// hdr/vs
inline MapParserBase::STYPE__ &MapParserBase::vs__(int idx) 
{
...
#define MapParser MapParserBase
