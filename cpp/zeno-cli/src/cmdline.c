/*
  ...
  /usr/bin/gengetopt -i /home/dcj/Projects/zeno-release/cpp/src/options.ggo --conf-parser --output-dir=/home/dcj/Projects/zeno-release/cpp/src --set-version=5.2.0 
