/*
  ...
  /usr/bin/gengetopt -i /home/dcj/Projects/zeno/cpp/zeno-cli/src/options.ggo --conf-parser --output-dir=/home/dcj/Projects/zeno/cpp/zeno-cli/src --set-version=5.3.0 
