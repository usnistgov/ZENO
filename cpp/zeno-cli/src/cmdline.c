/*
  ...
  /usr/bin/gengetopt -i /home/dcj/projects/zeno-release/cpp/zeno-cli/src/options.ggo --conf-parser --output-dir=/home/dcj/projects/zeno-release/cpp/zeno-cli/src --set-version=5.3.1 
