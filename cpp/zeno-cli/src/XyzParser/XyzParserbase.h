...
// hdr/includes
#ifndef xyz_parserXyzParserBase_h_included
#define xyz_parserXyzParserBase_h_included
...
struct TagOf<int>
{
    static Tag__ const tag = Tag__::INT_TYPE;
};
...
template <>
struct TypeOf<Tag__::STRING_TYPE>
{
    typedef std::string type;
};

template <>
struct TypeOf<Tag__::INT_TYPE>
{
    typedef int type;
};

template <>
struct TypeOf<Tag__::FLOAT_TYPE>
{
    typedef double type;
};
...
// hdr/abort
inline void XyzParserBase::ABORT() const
{
    throw PARSE_ABORT__;
}

// hdr/accept
inline void XyzParserBase::ACCEPT() const
{
...
// hdr/error
inline void XyzParserBase::ERROR() const
{
    throw UNEXPECTED_TOKEN__;
}

// hdr/savedtoken
inline int XyzParserBase::savedToken__() const
{
    return d_next.first;
}

// hdr/opbitand
inline XyzParserBase::DebugMode__ operator&(XyzParserBase::DebugMode__ lhs,
                                     XyzParserBase::DebugMode__ rhs)
{
    return static_cast<XyzParserBase::DebugMode__>(
...
inline XyzParserBase::DebugMode__ operator|(XyzParserBase::DebugMode__ lhs, 
                                     XyzParserBase::DebugMode__ rhs)
{
    return static_cast<XyzParserBase::DebugMode__>(static_cast<int>(lhs) | rhs);
};

// hdr/recovery
inline bool XyzParserBase::recovery__() const
{
    return d_recovery;
}

// hdr/stacksize
inline size_t XyzParserBase::stackSize__() const
{
    return d_stackIdx + 1;
}

// hdr/state
inline size_t XyzParserBase::state__() const
{
    return d_state;
}

// hdr/token
inline int XyzParserBase::token__() const
{
    return d_token;
}

// hdr/vs
inline XyzParserBase::STYPE__ &XyzParserBase::vs__(int idx) 
{
...
#define XyzParser XyzParserBase
