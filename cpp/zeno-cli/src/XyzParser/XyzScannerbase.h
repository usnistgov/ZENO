...
#ifndef xyz_parserXyzScannerBASE_H_INCLUDED
#define xyz_parserXyzScannerBASE_H_INCLUDED
...
private:
    ...
    size_t (XyzScannerBase::*d_get)() = &XyzScannerBase::getInput;
...
public:
    XyzScannerBase(XyzScannerBase const &other)             = delete;
    XyzScannerBase &operator=(XyzScannerBase const &rhs)    = delete;
...
protected:
    XyzScannerBase(std::istream &in, std::ostream &out);
    XyzScannerBase(std::string const &infilename, std::string const &outfilename);
    ~XyzScannerBase();
...
inline XyzScannerBase::~XyzScannerBase()
{
    d_input.close();
}

// $insert startcondimpl
inline XyzScannerBase::StartCondition__ constexpr XyzScannerBase::SC(int sc)
{
    return as<StartCondition__>(sc);
}

inline int constexpr XyzScannerBase::SC(StartCondition__ sc)
{
    return as<int>(sc);
}

inline XyzScannerBase::StartCondition__ XyzScannerBase::startCondition() const
{
    return SC(d_startCondition);
}

inline void XyzScannerBase::begin(StartCondition__ startCondition)
{
...
template <typename ReturnType, typename ArgType>
inline ReturnType constexpr XyzScannerBase::as(ArgType value)
{
    return static_cast<ReturnType>(value);
}

inline bool XyzScannerBase::knownFinalState()
{
    return (d_atBOL && available(d_final.bol.rule)) ||
           available(d_final.std.rule);
}

inline bool constexpr XyzScannerBase::available(size_t value)
{   
    return value != std::numeric_limits<size_t>::max();
}

inline std::ostream &XyzScannerBase::out()
{
    return *d_out;
}

inline void XyzScannerBase::push(size_t ch)
{
    d_input.reRead(ch);
}

inline void XyzScannerBase::push(std::string const &str)
{
    d_input.reRead(str, 0);
}

inline void XyzScannerBase::setFilename(std::string const &name)
{
    d_filename = name;
}

inline void XyzScannerBase::setMatched(std::string const &text)
{
    d_matched = text;
}

inline std::string const &XyzScannerBase::matched() const
{
    return d_matched;
}

inline std::string const &XyzScannerBase::filename() const
{
    return d_filename;
}

inline void XyzScannerBase::echo() const
{
    *d_out << d_matched;
}

inline size_t XyzScannerBase::length() const
{
    return d_matched.size();
}

inline void XyzScannerBase::leave(int retValue) const
{
    throw as<Leave__>(retValue);
}

inline size_t XyzScannerBase::lineNr() const
{
    return d_input.lineNr();
}

inline void XyzScannerBase::more()
{
    d_more = true;
}

inline size_t XyzScannerBase::state__() const
{
    return d_state;
}

inline size_t XyzScannerBase::get__()
{
    return (this->*d_get)();
}

inline size_t XyzScannerBase::getInput()
{
    return d_input.get();
}

inline bool XyzScannerBase::return__()
{
    return d_return;
}

inline void XyzScannerBase::noReturn__()
{
    d_return = false;
}
...
#endif //  XyzScannerBASE_H_INCLUDED
